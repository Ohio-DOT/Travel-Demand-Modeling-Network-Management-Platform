...
export default function UploadBaseModal({ isOpen, onClose, onSubmit }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="bg-white rounded-xl p-6 w-full max-w-xl shadow-xl">
        <h2 className="text-xl font-semibold mb-4">Create Base Network from Shapefiles</h2>
        <div className="text-sm mb-4">Only .zip file accepted. <br/> File should contain shapefiles named with the partial words "node" and "link" (not case sensitive). <br/> <div className="mt-2 text-center">E.g., ✅ "nodes" or "NODES" ❌ "nod" or "NOD"</div></div>
